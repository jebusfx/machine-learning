...
def ridge_regression_gradient_descent(feature_matrix, output, initial_weights, step_size, l2_penalty, max_iterations=100):
    ...
    for n_iterations in xrange(max_iterations):
        ...
        for i in xrange(len(weights)): # loop over each weight
            ...
            derivative = feature_derivative_ridge(errors,feature_matrix[:,i],weights[i],l2_penalty,True if i == 0 else False)
...
sum((test_output - predict_output(simple_test_feature_matrix,initial_weights))**2)
...
multiple_weights_0_penalty = ridge_regression_gradient_descent(
    feature_matrix, output, initial_weights, step_size, 0.0)
...
multiple_weights_high_penalty = ridge_regression_gradient_descent(
    feature_matrix, output, initial_weights, step_size, 1e11)
