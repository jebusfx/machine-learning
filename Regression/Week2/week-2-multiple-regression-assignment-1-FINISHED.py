...
print 'Bedrooms squared: {}'.format(test_data['bedrooms_squared'].mean())
print 'Bedrooms cross bathrooms: {}'.format(test_data['bed_bath_rooms'].mean())
print 'Log sqft living: {}'.format(test_data['log_sqft_living'].mean())
print 'Lat long: {}'.format(test_data['lat_plus_long'].mean())
